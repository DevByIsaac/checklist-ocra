...
AS $$
BEGIN
    INSERT INTO Actividades (empleado_id, tipo_actividad, descripcion, actividad_repetitiva, num_pausas,
                              lunch_break_duration, puntaje_ATD, puntaje_ATE, puntaje_acciones_fuerza,
                              puntaje_FSO, puntaje_FFM, created_by, updated_by)
    VALUES (p_empleado_id, p_tipo_actividad, p_descripcion, p_actividad_repetitiva, p_num_pausas,
